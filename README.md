...
`Assembly Guide.pdf`, `Painting Guide.pdf`, and a package manifest. The Side 2
files deliberately omit the Side 1 engraving layer so a CAM operator cannot
select the wrong face by accident.
